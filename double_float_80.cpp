...
void Split(const f80 &a, f80 &hi, f80 &lo) {
  if (Abs(a) > C1) { // overflow
    f80 b = {a.x0(), a.x1(), a.x2(), a.x3(), (u16)((a.x4() - 33u) & 0xffffu)};
    f80 t(C0*b);
    t -= (t - b);
    b -= t;
    hi = {t.x0(), t.x1(), t.x2(), t.x3(), (u16)((t.x4() + 33u) & 0xffffu)};
    lo = {b.x0(), b.x1(), b.x2(), b.x3(), (u16)((b.x4() + 33u) & 0xffffu)};
  } else {
    f80 t(C0*a);
    hi = t - (t - a);
    lo = a - hi;
...
inline void Rcp(float_80_t &f, const float_80_t &x) {
  __asm {
    mov rdx, x
    mov rcx, f
    fld1
